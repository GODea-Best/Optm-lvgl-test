...
void screen_service_warning_bold_create(lv_obj_t * old_scr)
{
    ...
    lv_label_set_text(lbl_msg, CFG_SERVICE_WARNING_DATE "\n" CFG_SERVICE_WARNING_DAYS);
    ...
    BOTTOM_BAR_CREATE(scr, lv_color_hex(0x00AACC));
