...
void screen_service_alert_bold_create(lv_obj_t * old_scr)
{
    ...
    lv_label_set_text(lbl_msg, CFG_SERVICE_ALERT_DATE "\n" CFG_SERVICE_ALERT_DAYS);
    ...
    BOTTOM_BAR_CREATE(scr, lv_color_hex(0x00D0FF));
