...
void screen_retest_alert_bold_create(lv_obj_t * old_scr)
{
    ...
    lv_label_set_text(lbl_title, "RETEST\nALERT");
    ...
    lv_label_set_text(lbl_msg, CFG_RETEST_TIME);
    ...
    BOTTOM_BAR_CREATE(scr, lv_color_hex(0xCC3300));
