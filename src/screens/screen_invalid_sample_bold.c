...
void screen_invalid_sample_bold_create(lv_obj_t * old_scr)
{
    ...
    lv_label_set_text(lbl_title, "INVALID\nSAMPLE");
    ...
    lv_label_set_text(lbl_msg, "Sample rejected,\nplease retry");
    ...
    BOTTOM_BAR_CREATE(scr, lv_color_hex(0x12246E));
