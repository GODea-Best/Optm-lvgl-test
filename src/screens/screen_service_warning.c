...
void screen_service_warning_create(lv_obj_t * old_scr)
{
    ...
    lv_obj_set_style_text_font(lbl_title, &lv_font_montserrat_extrabold_20, LV_PART_MAIN);
    ...
    static const lv_font_t * const date_fonts[] = {
        &lv_font_montserrat_semibold_20, &lv_font_montserrat_semibold_16,
    ...
    lv_obj_align(lbl_date, LV_ALIGN_TOP_MID, 0, 65);
    lv_obj_set_style_text_color(lbl_date, lv_color_hex(0x000000), LV_PART_MAIN);
    lv_obj_set_style_text_font(lbl_date,
        font_fit(CFG_SERVICE_WARNING_DATE, 112, date_fonts, 4), LV_PART_MAIN);
